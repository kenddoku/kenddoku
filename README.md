...
- **Simple DFT implementation (C, Python plots)**
  - [Simple Discrete Fourier Transform implementation (no FFT for now) that generates sine wave and analyzes its frequency spectrum](https://github.com/kenddoku/simple_dft_implementation)
